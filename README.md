# Jagex Launcher Beta Flatpak

[Click to install](./com.jagex.Launcher.flatpakref){: .btn}

This is a beta Flatpak package for the Jagex Launcher. It packages the official upstream Wine at the latest version, RuneLite, HDOS, and the Jagex Launcher.
...
flatpak remote-add --user --if-not-exists JagexLauncher https://jagexlauncher-beta.flatpak.mcswain.dev/JagexLauncher.flatpakrepo
